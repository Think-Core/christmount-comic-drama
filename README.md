...
这里不放小说正文，也不接管小说仓库的 Git 历史。这个仓库只负责改编阶段的产物：故事理解、人物整理、分集大纲、剧本、拆镜、AI 出图提示词、配音字幕和交付材料。

## 当前目录

- `workspace/00_项目说明/`：给接手人看的项目说明、上游内容位置和当前理解。
- `workspace/10_short-drama/`：短剧改编的核心材料，包括风格规则、分集大纲、前 5 集细化、EP01 剧本和 AI 漫剧拆镜稿。
